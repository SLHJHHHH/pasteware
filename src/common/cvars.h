...
struct cvars_ragebot
{
	...
	bool	raim_reaim_bypass;
	bool	raim_auto_fire;
	int		raim_hitchance_seeds;
	bind_t	raim_force_min_damage_key;
	int		raim_force_min_damage_value;
	int		raim_auto_scope;
...
struct cvars_legitbot
{
	...
	int		aim_flashed_check;
	bool	aim_shoot_through_teammates;
	bool	aim_pseudo_professional;
	bool	aim_write_demo_visible_only;
	bool	aim_mouse_event;
	bool	aim_fov_scale_by_fps;
	bool	aim_dynamic_fov;
	int		target_switch_delay;
	int		target_aim_selection;
	int		target_weight_head;
	int		target_weight_neck;
	int		target_weight_chest;
	int		target_weight_stomach;
	int		target_weight_arms;
	int		target_weight_legs;
	bool	aim_auto_scope;
	bool	aim_smooth_independence_fps;
	int		aim_block_attack_after_kill;
	bool	aim_dont_shoot_in_shield;
	bool	aim_demochecker_bypass;
	bool	aim_recoil_return_angles;
	bool	aim_recoil_no_mousemove_trigger;
	bool	aim_recoil_disable_smooth_auto;
	bind_t	aim_key;
	bind_t	aim_psilent_key;
	bool	trigger_only_scoped;
	bool	trigger_accurate_traces;
	bool	trigger_dynamic;
	bool	trigger_turn_off_after_first_bullet;
...
struct cvars_visuals
{
	...
	bool	remove_events;
	bool	watermark;
	bool	watermark_credits;
	bool	watermark_elements[8];
	bool	shared_esp;
	...
	bool	crosshair_dynamic;
	int		crosshair_dynamic_scale;
	bool	local_function_status;
	bool	local_hotkey_list;
	bool	local_statistics;
	bool	local_statistics_elements[3];
	bool	local_bullet_tracers;
	float	local_bullet_tracers_time;
	float	local_bullet_tracers_color[4];
	bool	effects_custom_color_hud;
	float	effects_custom_color_hud_color[4];
	float	effects_screen_fade_limit;
	bool	effects_color_filter;
	float	effects_color_filter_color[4];
	bool	effects_poly_filter;
