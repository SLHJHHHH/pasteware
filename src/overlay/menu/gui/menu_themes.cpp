...
void CMenuThemes::SetDefaultDarkTheme()
{
	...
	GImGui->Style.Colors[ImGuiCol_FrameBgActive] = ImColor(112, 112, 116, 255);
	GImGui->Style.Colors[ImGuiCol_CheckMark] = ImColor(190, 190, 195, 255);
	GImGui->Style.Colors[ImGuiCol_TitleBg] = ImColor(61, 59, 63, 150);
	GImGui->Style.Colors[ImGuiCol_TitleBgActive] = ImColor(61, 59, 63, 150);
	GImGui->Style.Colors[ImGuiCol_Tab] = ImColor(61, 59, 63, 150);
	GImGui->Style.Colors[ImGuiCol_TabHovered] = ImColor(96, 93, 96, 150);
	GImGui->Style.Colors[ImGuiCol_TabActive] = ImColor(112, 112, 116, 255);
