...
namespace General
{
	static void DrawAim(const std::unique_ptr<CMenuGui>& m_pGui)
	{
		...
		m_pGui->Checkbox(&cvars::legitbot.aim_recoil_return_angles, "Return angles"); m_pGui->Checkbox(&cvars::legitbot.aim_recoil_no_mousemove_trigger, "No mouse move trigger"); m_pGui->Checkbox(&cvars::legitbot.aim_recoil_disable_smooth_auto, "Disable smooth auto");
	...
	static void DrawTrigger(const std::unique_ptr<CMenuGui>& m_pGui)
	{
		...
		m_pGui->Slider(&cvars::legitbot.trigger_hitbox_scale[0], "Head scale", 1.f, 200.f, "%.0f%%", 1.f); m_pGui->Slider(&cvars::legitbot.trigger_hitbox_scale[1], "Neck scale", 1.f, 200.f, "%.0f%%", 1.f); m_pGui->Slider(&cvars::legitbot.trigger_hitbox_scale[2], "Chest scale", 1.f, 200.f, "%.0f%%", 1.f); m_pGui->Slider(&cvars::legitbot.trigger_hitbox_scale[3], "Stomach scale", 1.f, 200.f, "%.0f%%", 1.f); m_pGui->Slider(&cvars::legitbot.trigger_hitbox_scale[4], "Arms scale", 1.f, 200.f, "%.0f%%", 1.f); m_pGui->Slider(&cvars::legitbot.trigger_hitbox_scale[5], "Legs scale", 1.f, 200.f, "%.0f%%", 1.f);
